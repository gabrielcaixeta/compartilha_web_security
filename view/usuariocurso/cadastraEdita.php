...
<form name="lista" id="lista" action="" method="post">
    <table>
        ...
        while ($obj = mysqli_fetch_object($res)) {
            ...
            echo '<td><a href="area_restrita.php?pg=control/usuariocurso/cadastraEdita&idCurso=' . $obj->idCurso . '">Adicionar</a></td>';
            echo '</tr>';
            $linha++;
        }
        ?>
    ...
    <br />
    <a href="area_restrita.php?pg=view/usuariocurso/lista"> Voltar </a>
